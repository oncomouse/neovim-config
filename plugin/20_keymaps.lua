...
nmap_leader('fi', '<Cmd>Pick icons<CR>',                        'Icons')
...
nmap_leader('fu', '<Cmd>Pick undotree<CR>',                     'Undotree')
...
nmap_leader('lf', '<Cmd>lua require("conform").format(Config.conform_options)<CR>',   'Format')
...
xmap_leader('lf', '<Cmd>lua require("conform").format(Config.conform_options)<CR>', 'Format selection')
...
nmap('gl', function() MiniJump2d.start(vim.tbl_extend('keep', MiniJump2d.builtin_opts.line_start, {
