...
later(function()
	...
	MiniKeymap.map_multistep(
		"i",
		"<Tab>",
		{ "minisnippets_next", "increase_indent", "minisnippets_expand", "pmenu_next" }
	)
...
later(function()
	...
	MiniPick.registry.recent = require("mini.picker.recent")
	MiniPick.registry.undotree = require("mini.picker.undo")
	MiniPick.registry.icons = require("mini.picker.icons")
end)
...
later(function()
	...
	_G.Config.new_autocmd("BufWritePre", nil, function()
		MiniTrailspace.trim()
